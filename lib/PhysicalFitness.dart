...
class PhysicalFitness extends StatefulWidget {
  ...
  PhysicalFitness(this.text);

  @override
  _PhysicalFitness createState() => _PhysicalFitness();
}

class _PhysicalFitness extends State<PhysicalFitness> {
  List<Patients> patientList = [
    Patients(1, 0001, 'Sainath Hospital'),
    Patients(2, 0002, 'XYZ Hospital'),
    Patients(3, 0003, 'ABC Hospital'),
  ];
  List<PhysicalData> listOtdata = new List();
  List<PhysicalData> filteredUsers = List();
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Patients Pending For Physical Fitness'),
        ),
          ...
          child: Container(
              ...
              child: Column(children: <Widget>[
                Container(
                  ...
                  child: Text('Patients Pending For Physical Fitness',
                      style: TextStyle(
                        letterSpacing: 0.2,
                        fontSize: 18.00,
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return InkWell(child:Card(
                        ...
                        Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => PhysicalFitnessForm(
  ...
  Future<List<PhysicalData>> _fetchJobs() async {
...
/*
    ...
    if (response.statusCode == 200) {
      ...
      return jsonResponse.map((job) => new PhysicalData.fromJson(job)).toList();
    } else {
      throw Exception('Failed to load jobs from API');
    }
  }

  Widget _JobListView(List<PhysicalData> data) {
...
Card _tile(String patientname, String subtitle) => Card(
    child: ListTile(
      ...
      onTap: () =>
          Navigator.push(
          context, MaterialPageRoute(builder: (context) => PhysicalFitness('physical Fitness'))),
      /*leading: Icon(
    icon,
...
/*  "prnno": "fg",
  ...
  factory PhysicalData.fromJson(Map<String, dynamic> json) {
    return PhysicalData(
      prnno: json['prnno'],
